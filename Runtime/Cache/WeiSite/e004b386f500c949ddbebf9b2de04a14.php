...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
    <div class="tab-content">
      <!-- 表单 -->
       <form id='form' action='http://18.221.171.174/index.php?s=/w16/WeiSite/Footer/add/mdm/31%7C35.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-url '>
...
<div class='form-item cf toggle-pid '>
			...
			<div class='controls'><select name='pid'><option value='0' class='toggle-data' toggle-data='' selected >无</option><option value='5' class='toggle-data' toggle-data=''>私人营养师</option></select></div></div>
...
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1512213076' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1512213076' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1512213076' charset='UTF-8'></script> 
  <script type='text/javascript'>
