...
<html>
    ...
    <li><a href="javascript:;"><span>4</span><?php if(($_SESSION['weiphp_home']['update']) == "1"): ?>升级<?php else: ?>安装<?php endif; ?></a></li>
 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); ?>
    <h1>创建数据库</h1>
    <form action="/install.php?s=/w0/install/step2.html" method="post" target="_self">
