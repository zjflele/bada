...
<html>
    ...
    <li class="active"><a href="javascript:;"><span>4</span><?php if(($_SESSION['weiphp_home']['update']) == "1"): ?>升级<?php else: ?>安装<?php endif; ?></a></li>
    ...
    <!---
    <h1><?php if(($_SESSION['weiphp_home']['update']) == "1"): ?>升级<?php else: ?>安装<?php endif; ?></h1>
    -->
    ...
    <button class="btn btn-warning btn-large disabled">正在<?php if(($_SESSION['weiphp_home']['update']) == "1"): ?>升级<?php else: ?>安装<?php endif; ?>，请稍后...</button>
