...
<html>
    ...
    <li class="done"><a href="javascript:;"><span>&nbsp;&nbsp;</span><?php if(($_SESSION['weiphp_home']['update']) == "1"): ?>升级<?php else: ?>安装<?php endif; ?></a></li>
    ...
    <p><center><?php if(($_SESSION['weiphp_home']['update']) == "1"): ?>升级<?php else: ?>安装<?php endif; ?>完成！</center></p>
